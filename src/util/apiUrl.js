...
export const GET_THREADS_COMMENTS_API_URL = (thread_num) => `${BASE_URL}/threads/${thread_num}/comments`; // 스레드 부모 댓글 목록 조회 API URL
export const GET_COMMENT_REPLIES_API_URL = (parent_content_num) => `${BASE_URL}/comments/${parent_content_num}/replies`; // 대댓글 조회 API URL
...
// 리뷰 차트
export const GET_BOOK_REVIEW_DISTRIBUTION_API_URL = (bookId) => `${BASE_URL}/book-list/${bookId}/review-distribution`;
...
export const DELETE_MEMBER_API_URL = (member_num) => `${BASE_URL}/members/${member_num}`;
